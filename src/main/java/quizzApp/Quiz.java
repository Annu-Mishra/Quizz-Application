...
//////////////////////////////////////////////////////////////	
       ...
       next=new JButton("NEXT");
		...
		lifeline.setBounds(800,480,200,30);
		...
		submit.setBounds(800,540,200,30);
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==next) {
			...
			if(grpoption.getSelection()==null) {
				...
				useranswers[count][0]=grpoption.getSelection().getActionCommand();
			}
			if(count==8) {
